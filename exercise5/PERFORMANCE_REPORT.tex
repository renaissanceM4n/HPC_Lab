...
When increasing the number of threads while keeping the process count small (e.g., 4 MPI ranks), tiles such as $16\times 16$ or $64\times 64$ must be parallelized across many threads per process, which increases OpenMP scheduling and barrier overhead. By fixing the thread count at 4 and increasing the number of MPI ranks, the OpenMP parallelization of the pixel loop within a tile becomes more natural and efficient.
